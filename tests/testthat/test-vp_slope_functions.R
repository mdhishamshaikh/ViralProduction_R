...
# Perform
test_that("determine_vp_linear_allpoints", {
...
test_that("determine_vp_linear_separate_replicates", {
  data_NJ2020 <- read.csv(system.file('extdata', 'NJ2020_subset.csv', package = "viralprod"))
  DF_SR <- vp_separate_replicate_dataframe(data_NJ2020)
...
test_that("determine_vp_linear_average_replicates", {
  data_NJ2020 <- read.csv(system.file('extdata', 'NJ2020_subset.csv', package = "viralprod"))
...
test_that("determine_vp_linear_LMER_model", {
  data_NJ2020 <- read.csv(system.file('extdata', 'NJ2020_subset.csv', package = "viralprod"))
  DF_SR <- vp_separate_replicate_dataframe(data_NJ2020)
