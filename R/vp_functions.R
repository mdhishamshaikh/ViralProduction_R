...
slope_lm_sr<- function(df_sr){ #takes SR dataframe as an input
  ...
  colnames(slope_lm_sr_df)<- c('Location', 'Expt_No', 'Depth', 'Time_Range', 'Population', 'Sample_Type', 'Replicate', 'VP', 'VP_SE', 'VP_R_Squared')
  slope_lm_sr_df[, c('VP', 'VP_SE', 'VP_R_Squared')]<- lapply(slope_lm_sr_df[, c('VP', 'VP_SE', 'VP_R_Squared')], as.numeric)
